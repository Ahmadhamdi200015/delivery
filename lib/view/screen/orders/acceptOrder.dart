...
import 'package:delivery/view/widget/orders/accept_card_order.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: ListView(children: [
          const Center(child:Text("AcceptedOrder",style: TextStyle(fontSize: 20),)),
          GetBuilder<AcceptedController>(
